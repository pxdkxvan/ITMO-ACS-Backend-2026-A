...
class SecurityConfig(
    ...
    fun jwtDecoder(): JwtDecoder =
        NimbusJwtDecoder.withSecretKey(
            SecretKeySpec(companyProperties.security.jwtSecret.toByteArray(StandardCharsets.UTF_8), "HmacSHA256"),
        ...
        http
            ...
            .authorizeHttpRequests {
                it
                    ...
                    .requestMatchers("/companies", "/companies/**", "/employer-profiles", "/employer-profiles/**").hasRole("EMPLOYER")
