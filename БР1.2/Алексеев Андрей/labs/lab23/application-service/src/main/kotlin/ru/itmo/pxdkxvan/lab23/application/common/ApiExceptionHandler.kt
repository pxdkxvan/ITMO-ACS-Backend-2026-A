package ru.itmo.pxdkxvan.lab23.application.common
...
class ApiExceptionHandler {
    ...
    private fun resolveStatus(message: String?): HttpStatus {
        ...
        return when {
            "access denied" in normalized -> HttpStatus.FORBIDDEN
            "role " in normalized && "required" in normalized -> HttpStatus.FORBIDDEN
            "does not belong to current user" in normalized -> HttpStatus.FORBIDDEN
            "already exists" in normalized -> HttpStatus.CONFLICT
